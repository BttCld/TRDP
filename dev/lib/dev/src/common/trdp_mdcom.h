...
void        trdp_mdCheckPending (TRDP_APP_SESSION_T appHandle,
                                 TRDP_FDS_T*        pFileDesc,
                                 INT32*             pNoDesc);

void trdp_mdCheckListenSocks (const TRDP_SESSION_PT appHandle,
                              TRDP_FDS_T*           pRfds,
                              INT32*                pCount);

void trdp_mdCheckTimeouts (TRDP_SESSION_PT appHandle);

TRDP_ERR_T  trdp_mdCommonSend (const TRDP_MSG_T         msgType,
